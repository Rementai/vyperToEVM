...
public interface VyperEVMListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link VyperEVMParser#elseStatement}.
	 * @param ctx the parse tree
	 */
	void enterElseStatement(VyperEVMParser.ElseStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link VyperEVMParser#elseStatement}.
	 * @param ctx the parse tree
	 */
	void exitElseStatement(VyperEVMParser.ElseStatementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link VyperEVMParser#functionDefinition}.
	 * @param ctx the parse tree
	 */
	void enterFunctionDefinition(VyperEVMParser.FunctionDefinitionContext ctx);
	/**
	 * Exit a parse tree produced by {@link VyperEVMParser#functionDefinition}.
	 * @param ctx the parse tree
	 */
	void exitFunctionDefinition(VyperEVMParser.FunctionDefinitionContext ctx);
	/**
	 * Enter a parse tree produced by {@link VyperEVMParser#parameters}.
	 * @param ctx the parse tree
	 */
	void enterParameters(VyperEVMParser.ParametersContext ctx);
	/**
	 * Exit a parse tree produced by {@link VyperEVMParser#parameters}.
	 * @param ctx the parse tree
	 */
	void exitParameters(VyperEVMParser.ParametersContext ctx);
	/**
	 * Enter a parse tree produced by {@link VyperEVMParser#parameter}.
	 * @param ctx the parse tree
	 */
	void enterParameter(VyperEVMParser.ParameterContext ctx);
	/**
	 * Exit a parse tree produced by {@link VyperEVMParser#parameter}.
	 * @param ctx the parse tree
	 */
	void exitParameter(VyperEVMParser.ParameterContext ctx);
}